...
// N = 4:
//Result:
//(1)(1-y)^16 + (-81)(1-y)^14 + (388)(1-y)^13 + (88)(1-y)^12 + (-5180)(1-y)^11 + (14326)(1-y)^10 + (-6676)(1-y)^9 + (-43290)(1-y)^8 + (109984)(1-y)^7 + (-124036)(1-y)^6 + (71132)(1-y)^5 + (-13847)(1-y)^4 + (-5420)(1-y)^3 + (2763)(1-y)^2 + (-68)(1-y)^1 + (-84)= 0

//Wolfram:
//(1-y)^16 -81(1-y)^14 +388(1-y)^13+88(1-y)^12-5180(1-y)^11+14326(1-y)^10-6676(1-y)^9-43290(1-y)^8+109984(1-y)^7-124036(1-y)^6+71132(1-y)^5-13847(1-y)^4 -5420(1-y)^3 + 2763(1-y)^2 -68(1-y)^1 -84= 0
//11.5546
//It's right!
